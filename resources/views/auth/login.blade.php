    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card semi-transparent-card">
                <div class="card-header"><h3 class="font-weight-bold">{{ __('Login') }}</h3></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror input-transparent font-black" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror input-transparent font-black" name="password" required autocomplete="current-password">
